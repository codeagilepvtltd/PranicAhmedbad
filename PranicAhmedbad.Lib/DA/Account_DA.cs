...
namespace PranicAhmedbad.Lib.DA
{
    internal class Account_DA
    {
        ...
        {
            sqlQuery = new StringBuilder();
            object[] objParamName = { "intGlCode", "ref_LoginID", "varFirstName", "varMiddleName", "varLastName", "varAddressLine1", "varAddressLine2", "ref_AddressId", "ref_EntityTypeID", "ref_CityId", "varPostalCode", "varGender", "varContactNo", "varEmailAddress", "varGMapLocation", "dtDOB", "chrActive", "ref_EntryBy", "ref_UpdateBy", "varUserName", "varPassword" };
            object[] objParamValue = { customerMasterViewModel.customer_Master.intGlCode, customerMasterViewModel.customer_Master.ref_LoginID, customerMasterViewModel.customer_Master.varFirstName, customerMasterViewModel.customer_Master.varMiddleName, customerMasterViewModel.customer_Master.varLasteName
                    ...
                    customerMasterViewModel.customer_Master.dtDOB,customerMasterViewModel.customer_Master.chrActive,customerMasterViewModel.customer_Master.ref_EntryBy,customerMasterViewModel.customer_Master.dtEntryDate,customerMasterViewModel.customer_Master.varUserName,customerMasterViewModel.customer_Master.varPassword};
